...
- [ ] 1. Project setup and shared types
  - [ ] 1.1 Initialize Node.js project with TypeScript, ESM, and install dependencies
...
- [ ] 2. Session Manager
  - [ ] 2.1 Implement SessionManager with state machine
...
- [ ] 3. Metrics Extractor
  - [ ] 3.1 Implement MetricsExtractor
  ...
  - [ ]* 3.2 Write property test: Duration Computation Correctness
    - **Property 2: Duration Computation Correctness**
    - **Validates: Requirements 3.1**
  - [ ]* 3.3 Write property test: WPM Computation Correctness
    - **Property 3: WPM Computation Correctness**
    - **Validates: Requirements 3.2**
  - [ ]* 3.4 Write property test: Filler Word Metrics Internal Consistency
    - **Property 4: Filler Word Metrics Internal Consistency**
    - **Validates: Requirements 3.3**
  - [ ]* 3.5 Write property test: Pause Detection Correctness
    - **Property 5: Pause Detection Correctness**
    - **Validates: Requirements 3.4**
  - [ ]* 3.6 Write unit tests for contextual filler word detection
...
- [ ] 4. Checkpoint - Ensure all metrics tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Evaluation Generator
  - [ ] 5.1 Implement evidence validation logic
  ...
  - [ ]* 5.2 Write property test: Evidence Quote Validation
    - **Property 7: Evidence Quote Validation**
    - **Validates: Requirements 4.3, 4.6**
  - [ ] 5.3 Implement EvaluationGenerator with structured output
  ...
  - [ ]* 5.4 Write property test: Structured Evaluation Shape Invariant
    - **Property 8: Structured Evaluation Shape Invariant**
    - **Validates: Requirements 4.1, 4.2**
  - [ ] 5.5 Implement TTS Engine with pre-TTS time enforcement
  ...
  - [ ]* 5.6 Write property test: Evaluation Script Duration Compliance
    - **Property 6: Evaluation Script Duration Compliance**
    - **Validates: Requirements 4.5**

- [ ] 6. Checkpoint - Ensure all evaluation tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. Transcription Engine
  - [ ] 7.1 Implement Deepgram live caption integration
  ...
  - [ ] 7.2 Implement OpenAI post-speech transcription
  ...
  - [ ]* 7.3 Write property test: Transcript Structural Invariant
    - **Property 1: Transcript Structural Invariant**
    - **Validates: Requirements 2.2**

- [ ] 8. Audio capture and WebSocket server
  - [ ] 8.1 Implement WebSocket handler and Express server
  ...
  - [ ]* 8.2 Write property test: Audio Capture Inactive During Delivery
    - **Property 9: Audio Capture Inactive During Delivery**
    - **Validates: Requirements 5.3**

- [ ] 9. File Persistence
  - [ ] 9.1 Implement FilePersistence with opt-in saving
  ...
  - [ ]* 9.2 Write property test: Session Output File Round-Trip
    - **Property 10: Session Output File Round-Trip**
    - **Validates: Requirements 6.1, 6.2, 6.3**
  - [ ]* 9.3 Write property test: Output Directory Naming Convention
...
- [ ] 11. Web UI (browser client)
  - [ ] 11.1 Implement HTML/CSS control panel
  ...
  - [ ] 11.2 Implement browser audio capture with AudioWorklet
  ...
  - [ ] 11.3 Implement WebSocket client message handling
...
- [ ] 12. Integration wiring
  - [ ] 12.1 Wire the full pipeline in SessionManager
  ...
  - [ ] 12.2 Implement error handling flows
